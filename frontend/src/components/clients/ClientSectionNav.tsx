...
const TABS = [
  { href: ROUTES.clients, label: NAV_LABELS.clientAll, exact: true },
  { href: ROUTES.clientsAnalytics, label: NAV_LABELS.clientAnalytics, premium: true },
  {
